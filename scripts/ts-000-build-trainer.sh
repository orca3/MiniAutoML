...
docker build -t localhost:${REGISTRY_PORT}/orca3/intent-classification -f "$(dirname "$0")/../train-service/text-classification/Dockerfile" "$(dirname "$0")/../train-service/text-classification"
